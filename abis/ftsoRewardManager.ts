...
export const addresses = {
  ...
  flare: "0x6D55E24Dc2d3bD2Fc5Ae1fcCD1A73bc5f18A8A30",
};
...
export default [
  ...
  },
  {
    ...
    inputs: [
      { type: "address", name: "ftso", internalType: "address", indexed: true },
      {
        type: "uint256",
        name: "epochId",
        internalType: "uint256",
  ...
  },
  {
    ...
    inputs: [
      { type: "address", name: "_recipient", internalType: "address payable" },
      { type: "uint256[]", name: "_rewardEpochs", internalType: "uint256[]" },
      { type: "address[]", name: "_dataProviders", internalType: "address[]" },
    ],
  },
  {
    type: "function",
  ...
  },
  {
    ...
    inputs: [
      ...
      { type: "uint256", name: "_currentRewardEpoch", internalType: "uint256" },
      { type: "uint256", name: "_priceEpochEndTime", internalType: "uint256" },
  ...
  },
  {
    ...
    outputs: [
      ...
      { type: "uint256[]", name: "_validFromEpoch", internalType: "uint256[]" },
  ...
  },
  {
    ...
    inputs: [
      { type: "uint256", name: "_feePercentageBIPS", internalType: "uint256" },
    ],
  },
  {
    type: "function",
